...
7. Синтетические «здоровые» пациенты.
...
8. Предварительная обработка перед моделированием.
...
9. Построение нейросетевой модели.
...
– Финальная модель показывает следующие метрики: Accuracy: 0.9774, Recall: 0.9853.
...
10. Пример сервиса для развертывания.
...
11. Дополнительный скрипт классификации анемии.
...
12. Идеи для дальнейшего улучшения.
